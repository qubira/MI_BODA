...
(function initIntro() {
  ...
  var phase = 0; // 0=cerrado · 1=solapas abiertas · 2=cerrando

  /* Abre el sobre: 4 solapas se separan, sello se rompe, carta sube */
  ...
  /* Click en overlay: primer clic abre · segundo clic cierra */
  ...
  /* Botón "Abrir invitación" siempre visible bajo el sobre */
  if (enterBtn) {
