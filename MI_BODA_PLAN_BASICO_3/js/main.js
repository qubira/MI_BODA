/* ============================================================
   MI BODA — JavaScript Principal v3
...
/* ===== INTRO — SECUENCIA DE FOTOS + TOCA PARA ENTRAR ===== */
(function initIntro() {
  var overlay = document.getElementById('introOverlay');
  if (!overlay) return;

  var brideEl = document.getElementById('introBride');
  var groomEl = document.getElementById('introGroom');
  ...
  function update() {
    ...
    if (diff <= 0) {
      document.getElementById('countdown').innerHTML =
        `<p style="color:var(--blue-deep);font-family:var(--font-display);font-weight:700;font-size:1.6rem">¡Hoy es el gran día! 💍</p>`;
      return;
    }
